...
int test_speed(void)
{
	...
	kcycles=0;
 	cycles1 = cpucycles();
  	...
  	cycles2 = cpucycles();
  	kcycles = cycles2-cycles1;
  	printf("  sample_A runs in ................. %8lld cycles", kcycles/TEST_LOOP);
    printf("\n"); 
	...
	cycles2 = cpucycles();
    kcycles = cycles2-cycles1;
    printf("  sample_s runs in ................. %8lld cycles", kcycles/TEST_LOOP);
    printf("\n"); 
	...
	cycles2 = cpucycles();
    kcycles = cycles2-cycles1;
    printf("  pack_poly runs in ................. %8lld cycles", kcycles/TEST_LOOP);
    printf("\n"); 
	...
	cycles2 = cpucycles();
    kcycles = cycles2-cycles1;
    printf("  unpack_poly runs in ................. %8lld cycles", kcycles/TEST_LOOP);
    printf("\n"); 
	...
	cycles2 = cpucycles();
    kcycles = cycles2-cycles1;
    printf("  pack_z runs in ................. %8lld cycles", kcycles/TEST_LOOP);
    printf("\n"); 
	...
	cycles2 = cpucycles();
    kcycles = cycles2-cycles1;
    printf("  sample_c runs in ................. %8lld cycles", kcycles/TEST_LOOP);
    printf("\n");
	...
	cycles2 = cpucycles();
    kcycles = cycles2-cycles1;
    printf("  sample_y runs in ................. %8lld cycles", kcycles/TEST_LOOP);
    printf("\n");
	...
	cycles2 = cpucycles();
    kcycles = cycles2-cycles1;
    printf("  polyvec_cadd runs in ................. %8lld cycles", kcycles/TEST_LOOP);
    printf("\n"); 
	...
	cycles2 = cpucycles();
    kcycles = cycles2-cycles1;
    printf("  ntt runs in ................. %8lld cycles", kcycles/TEST_LOOP);
    printf("\n"); 
	...
	cycles2 = cpucycles();
    kcycles = cycles2-cycles1;
    printf("  invntt runs in ................. %8lld cycles", kcycles/TEST_LOOP);
    printf("\n");
	
    printf("poly_mul_kara\n");
	kcycles=0;
	cycles1 = cpucycles();
	for(i = 0; i < TEST_LOOP; ++i) 
    	poly_basemul(t, A[0][0],s[0]);
    cycles2 = cpucycles();
    kcycles = cycles2-cycles1;
	...
	cycles2 = cpucycles();
    kcycles = cycles2-cycles1;
    printf("  polyvec_mul runs in ................. %8lld cycles", kcycles/TEST_LOOP);
    printf("\n"); 
